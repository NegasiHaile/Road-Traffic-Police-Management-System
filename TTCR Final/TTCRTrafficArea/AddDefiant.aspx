<%@ Page Title="" Language="C#" MasterPageFile="~/TTCRTrafficArea/TrafficArea.master" AutoEventWireup="true" CodeFile="AddDefiant.aspx.cs" Inherits="TTCRTrafficArea_AddDefiant" %>
                            ...
                            <div class="mt-3">
                                <div class="form-row col-12">
                                    ...
                                    <div class="form-group col-9">
                                        <asp:DropDownList ID="ddlBranchname" CssClass="textBoxstyle text-capitalize" Style="color: black; font-weight: bold; font-family: Cambria; font-size: 12px;" runat="server" DataTextField="CHOOSE" DataValueField="BACK" required="required">
                                ...
                                <div class="form-row col-12">
                                    ...
                                    <div class="form-group col-9">
                                        <asp:DropDownList ID="ddlLocationName" CssClass="textBoxstyle text-capitalize" Style="color: black; font-weight: bold; font-family: Cambria; font-size: 12px;" runat="server" DataTextField="CHOOSE" DataValueField="BACK" required="required">
                                            <asp:ListItem Selected="true" disabled>Select!</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
