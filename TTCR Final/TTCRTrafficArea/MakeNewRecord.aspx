<%@ Page Title="" Language="C#" MasterPageFile="~/TTCRTrafficArea/TrafficArea.master" AutoEventWireup="true" CodeFile="MakeNewRecord.aspx.cs" Inherits="TTCRTrafficArea_MakeNewRecord" %>
                   ...
                   <div style="border: solid 1px gray; padding: 1px; margin: -15px; margin-bottom: 0px; border-radius: 5px;">
                        ...
                        <div style="border: solid 1px gray; padding: 5px; margin: -15px; margin-top: 0px; border-radius: 5px;">
                            ...
                            <div class="form-group">
                                <asp:Button ID="btnSaveRecord" class="btn btn-primary btn-block" runat="server" Text="Save record" OnClick="btnSaveRecord_Click" />
                            </div>
                        </div>
                    ...
                    <div class="border-top" style="margin: 3px;">
                        <small class="text-center"><span style="color: red; text-transform: uppercase;">Note</span>: By selcting the above agreement checkbox you are agreering to take responsibility for any of risk happend at 
