<%@ Page Title="" Language="C#" MasterPageFile="~/TTCRTrafficArea/TrafficArea.master" AutoEventWireup="true" CodeFile="RecordDetailAfterrecorded.aspx.cs" Inherits="TTCRTrafficArea_RecordDetailAfterrecorded" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row  justify-content-center">
        ...
        <div class="col-12">
            <a href="TodayRecords.aspx" class="btn btn-outline-primary mt-1" title="Back To List"><i class="fa fa-backward"></i>Back To List</a>
        </div>
                                ...
                                <div  style="border: solid 1px gray; padding: 5px; margin: -15px; margin-top: 0px; border-radius: 5px;">
                                    ...
                                    <div class="form-row col-12">
                                        <div class="form-group col-3" style="border: solid 1px black; text-align: center; border-radius: 5px;">
                                            ...
                                            <asp:LinkButton ID="lbtnPunshimentPaid" CssClass="btn btn-block btn-success textBoxstyle" Style="text-align: center" runat="server" OnClick="lbtnPunshimentPaid_Click">is it Paid?</asp:LinkButton>
                                    ...
                                    <div class="form-row col-12 mt-2 mb-5">
                                        <div class="form-row col-7">
                                            <span class=" textBoxstyle"><span>Payer Confirmation :</span> <span class="text-uppercase" style="text-align: center" runat="server" id="spnPunishmentAgreementStatus"></span></span>
                                        </div>

                                        <div class="form-row col-5 ml-1">
                                            <span class=" textBoxstyle"><span>Payment :</span> <span class="text-uppercase" style="text-align: center" runat="server" id="spnPaymentStatus"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </article>
                        ...
                        <div style="border: solid 1px gray; padding: 5px; margin: -15px; margin-top: 0px; border-radius: 5px;">
                            ...
                            <div class="form-row col-12">
                                <div class="form-row col-6">
                                    <span class="btn  btn-danger textBoxstyle"><span>Payer :</span> <span class="text-uppercase" style="text-align: center" runat="server" id="spnPunishmentAgreementStatus"></span></span>
                                </div>

                                <div class="form-row col-6 ml-1">
