<%@ Page Title="" Language="C#" MasterPageFile="~/TTCROwnerArea/OwnerArae.master" AutoEventWireup="true" CodeFile="DriverDetaileToOwner.aspx.cs" Inherits="TTCROwnerArea_DriverDetaileToOwner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <div class="content" >
        <div class="justify-content-center">
            <div class="row col-10" runat="server" id="divnotaxiDriverMessage">
                <hp class="text-uppercase font-italic text-center"> This Taxi has not Assigned a driver. <a href="RegisterNewDriver.aspx">Click Here</a> if you need to assign it.</hp>
