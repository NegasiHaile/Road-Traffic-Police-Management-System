<%@ Page Title="" Language="C#" MasterPageFile="~/TTCRBranchAdmin/BranchAdmin.master" AutoEventWireup="true" CodeFile="ToadysActivityFromBranchAdmin.aspx.cs" Inherits="TTCRBranchAdmin_ToadysActivityFromBranchAdmin" %>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center">ኣብ <span runat="server" id="spnbranchName">Name Of Branch</span> በዚ ዕለት እዚ ዝተሰርሑ ስራሕቲ</h5>
                            <hr />
                    </div>
                ...
                <div class="card strpied-tabled-with-hover">
                    <div class="card-header ">
                        <header class="card-header">
                            <h4 class="card-title mt-2">Work history</h4>
                        </header>
