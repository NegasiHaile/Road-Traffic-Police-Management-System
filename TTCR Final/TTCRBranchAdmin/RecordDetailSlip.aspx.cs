...
public partial class TTCRBranchAdmin_RecordDetailSlip : System.Web.UI.Page
{
    ...
    private void getRecordData()
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            spnWereda.InnerText = dt_fetchRecordDetail.Rows[0][2].ToString();
            tbBranchName.Text = dt_fetchRecordDetail.Rows[0][2].ToString();
            tbDriverLicenseNO.Text = dt_fetchRecordDetail.Rows[0][5].ToString() +"   Phone=("+ dt_fetchRecordDetail.Rows[0][1].ToString() +")";
