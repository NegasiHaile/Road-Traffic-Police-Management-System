<%@ Page Title="" Language="C#" MasterPageFile="~/TTCRSuperAdmin/SuperAdmin.master" AutoEventWireup="true" CodeFile="TaxiDetailToSuperAdmin.aspx.cs" Inherits="TTCRSuperAdmin_TaxiDetailToSuperAdmin" %>
                    ...
                    <div class="row card-body">
                        ...
                        <div class="row col-md-8">
                            ...
                            <div class="col-sm-4">
                                ...
                                <span class="textfont"><span>* Name  : </span>  <a href="TaxiOwnerDetail.aspx?Phone_No=<%= OwnerPhone %>" id="spnOwnerFullName" class="pull-right spnsFont"> <%= OwnerFullName %></a></span>
                                <br />
                            ...
                            <div class="col-sm-4">
                                ...
                                <span class="textfont"><span>* Name : </span> <span id="spnDriverFullName" runat="server" class="pull-right spnsFont">Not Assigned</span></span>
                                <br />
                            ...
                            <div class="row col-sm-12">
                                <div class="col-5">
                                    <asp:FileUpload ID="fupldTaxilibre" CssClass="form-control" runat="server" />
                                </div>
                                <div class="col-5">
                                    <asp:Button ID="btnchangetaxifile" runat="server" CssClass="btn btn-sm btn-primary" Text="Chenge Taxi Photo" OnClick="btnchangetaxifile_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
