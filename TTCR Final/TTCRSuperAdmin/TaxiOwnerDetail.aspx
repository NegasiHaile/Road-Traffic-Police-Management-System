<%@ Page Title="" Language="C#" MasterPageFile="~/TTCRSuperAdmin/SuperAdmin.master" AutoEventWireup="true" CodeFile="TaxiOwnerDetail.aspx.cs" Inherits="TTCRSuperAdmin_TaxiOwnerDetail" %>
                                    ...
                                    <asp:Repeater ID="rptrListOfTaxisPerOwner" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%# Eval("Id") %></td>
                                            <td>
                                                <a href="TaxiDetailToSuperAdmin.aspx?Plate=<%# Eval("Plate") %>" title="See libre of the taxi"><span runat="server" id="Span1"><%# Eval("Plate") %></span></a>
                                            </td>
                                                <td><%# Eval("Level") %></td>
                                                <td><%# Eval("Color") %></td>
                                            </tr>
